...
{{
  "concept_name": {{
    "description": "A brief description of the concept or entity.",
  }}
}}
...
concepts_extractor = extract_concepts_prompt | llm_small | output_parser | parse_json | store_concepts_to_db

concepts_retriever = concepts_retriever_prompt | llm_small | output_parser | parse_json | get_previous_concepts
